      ...
      <form class="" action="<?php echo base_url('Admin/updatePeserta/'.$key['pin']);?>" method="post">
        <input type="hidden" name="_token" value=" csrf_token() ">
          ...
          <div class="form-group" id="instansi" style="display:none">
            <input type="text" name="instansi" class="form-control"value="<?php echo $key['instansi'] ?>" hidden="true" />
          </div>
          <div class="form-group" id="jurusan"  style="display:none">
            <input type="text" name="jurusan" class="form-control" value="<?php echo $key['jurusan'] ?>" hidden="true" />
          </div>
